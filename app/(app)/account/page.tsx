...
export default function AccountPage() {
  ...
  if (!user || !statusData) {
    return (
      <div style={{ minHeight: '100vh', background: '#021B3A', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'var(--font-sans)' }}>
        Loading…
      </div>
    )
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#021B3A', color: '#fff', fontFamily: 'var(--font-sans)' }}>
      {/* Nav */}
