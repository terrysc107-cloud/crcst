      ...
      <div className="min-h-screen flex items-center justify-center p-4" style={{
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-10">
            ...
            <p style={{ color: "#7B96A8", fontSize: "1rem", fontFamily: "var(--font-sans)" }}>
          ...
          <div style={{
            ...
            {/* Cert selector */}
            <div className="mb-6">
              <label style={{ display: "block", color: "#14BDAC", fontSize: "0.75rem", letterSpacing: "0.1em", marginBottom: "0.6rem", fontFamily: "var(--font-sans)" }}>
            ...
            <div className="mb-5">
              ...
              />
              {errors.name && <p style={{ color: "#E85D04", fontSize: "0.8rem", marginTop: "0.3rem", fontFamily: "var(--font-sans)" }}>{errors.name}</p>}
            </div>
            ...
            <div className="mb-5">
              ...
              />
              {errors.hspaMember
                ? <p style={{ color: "#E85D04", fontSize: "0.8rem", marginTop: "0.3rem", fontFamily: "var(--font-sans)" }}>{errors.hspaMember}</p>
                : <p style={{ color: "#7B96A8", fontSize: "0.78rem", marginTop: "0.35rem", fontFamily: "var(--font-sans)" }}>Found on your HSPA membership card or at hspa.com</p>
              }
            </div>
            ...
            {errors.submit && (
              <div style={{
                ...
                <p style={{ color: "#E85D04", fontSize: "0.88rem", margin: 0, fontFamily: "var(--font-sans)" }}>
                  {errors.submit}
                </p>
              </div>
            )}
            ...
            <p style={{ textAlign: "center", color: "#7B96A8", fontSize: "0.75rem", marginTop: "1rem", fontFamily: "var(--font-sans)" }}>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{
        ...
        <div className="text-center px-4">
          ...
          <p style={{ color: "#FFFFFF", fontSize: "1.1rem", fontFamily: "var(--font-serif)" }}>
            Verifying your certification…
          </p>
          <p style={{ color: "#7B96A8", fontSize: "0.85rem", marginTop: "0.5rem", fontFamily: "var(--font-sans)" }}>
    ...
    return (
      <div className="min-h-screen relative overflow-hidden" style={{
        ...
        <div className="relative z-20 max-w-2xl mx-auto px-4 py-10 text-center">
          ...
          <p style={{ color: "#A0BCD0", fontSize: "1rem", marginBottom: "2.5rem", fontFamily: "var(--font-sans)" }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ color: "#7B96A8", fontSize: "0.7rem", letterSpacing: "0.08em", fontFamily: "var(--font-sans)", marginTop: "0.2rem" }}>{s.label.toUpperCase()}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: cfg.accent, fontSize: "0.78rem", marginTop: "0.75rem", letterSpacing: "0.08em", fontFamily: "var(--font-sans)" }}>
              — ASEPTIC TECHNICAL SOLUTIONS
            </p>
          </div>
        ...
        <div className="w-full max-w-lg text-center">
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: cfg.accent, fontSize: "0.8rem", fontFamily: "var(--font-sans)",
            }}>{cert} ✓</span>
            <span style={{ color: "#7B96A8", fontSize: "1.2rem" }}>→</span>
            <span style={{
              background: `${nextCfg.color}30`, border: `1px solid ${nextCfg.accent}`,
              borderRadius: "100px", padding: "0.25rem 0.8rem",
              color: nextCfg.accent, fontSize: "0.8rem", fontFamily: "var(--font-sans)",
            }}>{cfg.next}</span>
          </div>
          ...
          <p style={{ color: "#A0BCD0", fontSize: "1rem", marginBottom: "2.5rem", lineHeight: 1.6, fontFamily: "var(--font-sans)" }}>
            {cfg.nextDesc}
          </p>
          ...
          <div style={{
            ...
            <div style={{ color: "#FFFFFF", fontSize: "0.95rem", fontFamily: "var(--font-sans)", opacity: 0.85 }}>
              {cfg.nextLabel}
            </div>
            ...
            <div style={{ marginTop: "1.5rem", textAlign: "left" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <span style={{ color: "#D0E4EE", fontSize: "0.88rem", fontFamily: "var(--font-sans)" }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              fontFamily: "var(--font-serif)", marginBottom: "0.75rem", lineHeight: 1.3,
            }}>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.25rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              {[
                ...
                <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: "0.5rem", color: "#C8D8E0", fontSize: "0.88rem", fontFamily: "var(--font-sans)" }}>
