...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <div style={{ background: "#021B3A", color: "#FFFFFF", fontFamily: "var(--font-sans)", overflowX: "hidden" }}>
        ...
        <section className="grid-dot-bg" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "8rem 1.5rem 5rem", overflow: "hidden" }}>
          ...
          <div className="hide-mobile" style={{ position: "absolute", left: "8%", top: "30%", animation: "floatA 5s ease-in-out infinite" }}>
            <div style={{ background: "rgba(13,115,119,0.25)", border: "1px solid rgba(20,189,172,0.4)", borderRadius: 12, padding: "0.6rem 1rem", backdropFilter: "blur(8px)" }}>
              <span style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.8rem", fontWeight: 600 }}>CRCST ✓</span>
            </div>
          </div>
          <div className="hide-mobile" style={{ position: "absolute", right: "8%", top: "25%", animation: "floatB 6s ease-in-out infinite 1s" }}>
            <div style={{ background: "rgba(26,74,138,0.25)", border: "1px solid rgba(74,144,217,0.4)", borderRadius: 12, padding: "0.6rem 1rem", backdropFilter: "blur(8px)" }}>
              <span style={{ color: "#4A90D9", fontFamily: "var(--font-mono)", fontSize: "0.8rem", fontWeight: 600 }}>CHL ✓</span>
            </div>
          </div>
          <div className="hide-mobile" style={{ position: "absolute", right: "12%", bottom: "28%", animation: "floatA 7s ease-in-out infinite 0.5s" }}>
            <div style={{ background: "rgba(91,45,142,0.25)", border: "1px solid rgba(155,89,214,0.4)", borderRadius: 12, padding: "0.6rem 1rem", backdropFilter: "blur(8px)" }}>
              <span style={{ color: "#9B59D6", fontFamily: "var(--font-mono)", fontSize: "0.8rem", fontWeight: 600 }}>CER ✓</span>
            </div>
          </div>
          ...
          <div ref={heroRef} style={{ maxWidth: 780, textAlign: "center", position: "relative", zIndex: 2 }}>
            ...
            <div style={{
              ...
              <span style={{ color: "#14BDAC", fontSize: "0.78rem", fontWeight: 600, fontFamily: "var(--font-mono)", letterSpacing: "0.08em" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.8rem", marginTop: "1.25rem", fontFamily: "var(--font-mono)" }}>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", textAlign: "center" }}>
            {[
              ...
              <div key={i} style={{ opacity: statsInView ? 1 : 0, transition: `opacity 0.5s ${i * 0.1}s` }}>
                <div style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 900, color: "#14BDAC", lineHeight: 1 }}>
                  {statsInView ? <Counter end={st.n} suffix={st.s} /> : "0"}
                </div>
                <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.8rem", marginTop: "0.4rem", fontWeight: 400, fontFamily: "var(--font-mono)", letterSpacing: "0.05em" }}>{st.label}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="features" ref={featRef} style={{ padding: "6rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>WHAT YOU GET</p>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 900, lineHeight: 1.15 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.25rem" }}>
            {FEATURES.map((f, i) => (
              <div key={i} className={`feat-card reveal ${featInView ? "visible" : ""} reveal-delay-${(i % 4) + 1}`}>
                ...
                <h3 style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", fontWeight: 600, marginBottom: "0.6rem", color: "#FFFFFF" }}>{f.title}</h3>
        ...
        <section id="certifications" ref={certRef} style={{ padding: "5rem 1.5rem", background: "rgba(255,255,255,0.015)", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>EXAM COVERAGE</p>
              <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 900 }}>
              ...
              {CERTS.map((c, i) => (
                <div key={i} className={`cert-card reveal ${certInView ? "visible" : ""} reveal-delay-${i + 1}`} style={{ borderColor: `${c.accent}20` }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1rem" }}>
                    ...
                    <span style={{ background: `${c.color}40`, border: `1px solid ${c.accent}`, borderRadius: 100, padding: "0.2rem 0.7rem", color: c.accent, fontSize: "0.7rem", fontFamily: "var(--font-mono)", fontWeight: 600 }}>
                      {c.questions}+ Qs
                    </span>
                  </div>
                  <div style={{ color: c.accent, fontFamily: "var(--font-mono)", fontSize: "1.3rem", fontWeight: 700, letterSpacing: "0.05em", marginBottom: "0.3rem" }}>{c.code}</div>
        ...
        <section style={{ padding: "6rem 1.5rem", maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>THE PROCESS</p>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 900 }}>
            ...
            {[
              ...
              <div key={i} style={{ textAlign: "center", padding: "1.5rem 1rem" }}>
                <div style={{
                  ...
                  fontFamily: "var(--font-mono)", color: "#14BDAC", fontWeight: 600, fontSize: "0.95rem",
                }}>
                  {s.step}
                </div>
        ...
        <section ref={testRef} style={{ padding: "5rem 1.5rem", background: "rgba(255,255,255,0.015)", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>FROM THE COMMUNITY</p>
              <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.6rem, 3.5vw, 2.5rem)", fontWeight: 900 }}>
              ...
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className={`testimonial-card reveal ${testInView ? "visible" : ""} reveal-delay-${i + 1}`}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <span style={{ background: "rgba(20,189,172,0.12)", border: "1px solid rgba(20,189,172,0.3)", borderRadius: 100, padding: "0.2rem 0.65rem", color: "#14BDAC", fontSize: "0.72rem", fontFamily: "var(--font-mono)" }}>
                      {t.cert} ✓
                    </span>
                  </div>
                </div>
        ...
        <section style={{ background: "#021B3A", padding: "5rem 1.5rem" }}>
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }} className="resume-grid">
              <div>
                <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.72rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>CAREER SERVICES</p>
                <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.6rem, 3.5vw, 2.4rem)", fontWeight: 900, lineHeight: 1.2, marginBottom: "1.25rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
                  ...
                  <div key={label} style={{
                    ...
                    <div style={{ fontFamily: "var(--font-serif)", fontSize: "2rem", fontWeight: 900, color: "#14BDAC", lineHeight: 1, flexShrink: 0 }}>{stat}</div>
                    <div>
        ...
        <section id="pricing" ref={pricingRef} style={{ padding: "6rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>PLANS</p>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 900 }}>
            ...
            {PLANS.map((p, i) => (
              <div key={i} className={`pricing-card reveal ${pricingInView ? "visible" : ""} reveal-delay-${i + 1} ${p.highlight ? "highlight" : ""}`}>
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  <h3 style={{ fontFamily: "var(--font-mono)", fontSize: "0.85rem", letterSpacing: "0.08em", color: p.highlight ? "#14BDAC" : "rgba(255,255,255,0.5)", marginBottom: "0.75rem" }}>
                    {p.name.toUpperCase()}
                  </h3>
                  <div style={{ display: "flex", alignItems: "baseline", gap: "0.2rem" }}>
                    <span style={{ fontFamily: "var(--font-serif)", fontSize: "2.8rem", fontWeight: 900, color: "#FFFFFF" }}>{p.price}</span>
                ...
                <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.75rem", textAlign: "center", marginTop: "0.75rem", fontFamily: "var(--font-mono)" }}>
                  {p.note}
                </p>
              </div>
            ))}
        ...
        <section style={{ padding: "5rem 1.5rem", background: "rgba(13,115,119,0.06)", borderTop: "1px solid rgba(20,189,172,0.15)", borderBottom: "1px solid rgba(20,189,172,0.15)" }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
            <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "1rem" }}>FOR FACILITIES & DEPARTMENTS</p>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.6rem, 3.5vw, 2.4rem)", fontWeight: 900, marginBottom: "1rem" }}>
        ...
        <section id="faq" style={{ padding: "6rem 1.5rem", maxWidth: 720, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <p style={{ color: "#14BDAC", fontFamily: "var(--font-mono)", fontSize: "0.75rem", letterSpacing: "0.12em", marginBottom: "0.75rem" }}>FAQ</p>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.8rem, 4vw, 2.6rem)", fontWeight: 900 }}>
              Common questions
            </h2>
          </div>
        ...
        <section style={{ padding: "6rem 1.5rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: 620, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, lineHeight: 1.1, marginBottom: "1.25rem" }}>
...
<a href="/crcst" className="btn-primary" style={{ fontSize: "1.1rem", padding: "1.1rem 2.6rem", textDecoration: "none" }}>
  Create Your Free Account →
            ...
            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.78rem", marginTop: "1rem", fontFamily: "var(--font-mono)" }}>
        ...
        <footer style={{ borderTop: "1px solid rgba(255,255,255,0.07)", padding: "3rem 1.5rem" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2rem" }}>
            <div>
              <div style={{ fontFamily: "var(--font-serif)", fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.75rem" }}>
                SPD Cert <em style={{ color: "#14BDAC" }}>Prep</em>
              </div>
            ...
            <div>
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.72rem", letterSpacing: "0.1em", fontFamily: "var(--font-mono)", marginBottom: "0.75rem" }}>PRODUCT</p>
              {[
            ...
            <div>
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.72rem", letterSpacing: "0.1em", fontFamily: "var(--font-mono)", marginBottom: "0.75rem" }}>ACCOUNT</p>
              {[
            ...
            <div>
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.72rem", letterSpacing: "0.1em", fontFamily: "var(--font-mono)", marginBottom: "0.75rem" }}>COMPANY</p>
              {[
          ...
          <div style={{ maxWidth: 1100, margin: "2rem auto 0", paddingTop: "2rem", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
            <p style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.78rem", fontFamily: "var(--font-mono)" }}>
              © 2026 Scott Advisory Group · Aseptic Technical Solutions
            </p>
            <div style={{ display: "flex", gap: "1.5rem", alignItems: "center", flexWrap: "wrap" }}>
              <a href="/terms" style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.75rem", fontFamily: "var(--font-mono)", textDecoration: "none" }}>Terms of Service</a>
              <a href="/privacy" style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.75rem", fontFamily: "var(--font-mono)", textDecoration: "none" }}>Privacy Policy</a>
              <p style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.75rem", fontFamily: "var(--font-mono)", margin: 0 }}>
