    ...
    <div className="min-h-screen bg-navy text-white">
      ...
      <section className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Link href="/pricing"
            className="px-8 py-4 rounded-xl font-semibold text-lg text-white shadow-lg shadow-amber/20 hover:-translate-y-0.5 transition-all bg-gradient-to-br from-amber to-amber-2">
            Unlock CER Access
          </Link>
          <Link href="/crcst"
      ...
      <section className="py-16 px-4 text-center border-t border-white/7">
        ...
        <Link href="/pricing"
          className="inline-flex px-8 py-4 rounded-xl font-semibold text-white text-lg shadow-lg shadow-amber/20 hover:-translate-y-0.5 transition-all bg-gradient-to-br from-amber to-amber-2">
          Get CER Access →
        </Link>
      </section>
