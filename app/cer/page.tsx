                  ...
                  return (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <Progress
                          value={progress}
                          className="w-24 h-1 bg-cream-2 [&_[data-slot=progress-indicator]]:bg-blue-500 [&_[data-slot=progress-indicator]]:transition-all [&_[data-slot=progress-indicator]]:duration-500"
                        />
                      </div>
