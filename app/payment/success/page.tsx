...
function PaymentSuccessContent() {
  ...
  return (
    <div className="max-w-[480px] w-full text-center bg-white/[0.04] border border-teal/30 rounded-[20px] px-8 py-12">
      {/* Checkmark */}
      ...
      <Link
        href="/dashboard"
        className="inline-flex items-center justify-center gap-2 py-[0.85rem] px-10 rounded-[10px] bg-gradient-to-r from-teal-dark to-teal text-white font-semibold text-base"
      >
        Go to Dashboard
      </Link>
    </div>
...
export default function PaymentSuccessPage() {
  return (
    <div className="min-h-screen bg-navy flex flex-col items-center justify-center font-sans text-white p-8 gap-6">
      ...
      <div className="max-w-[480px] w-full bg-teal/[0.06] border border-teal/25 rounded-2xl p-6 text-center">
        <p className="text-xs tracking-[0.1em] text-teal font-mono mb-2 uppercase">
          WHILE YOU STUDY
        </p>
        ...
        <a
          ...
          className="inline-block px-6 py-[0.6rem] rounded-lg border border-teal/50 text-teal text-[0.88rem] font-semibold no-underline"
        >
