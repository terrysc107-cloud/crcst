  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-2 to-navy">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        {q.context && (
          <div className="bg-white/[4%] border border-white/[8%] rounded-[10px] px-5 py-4 mb-5 text-white/70 text-[0.9rem] leading-[1.7] italic">
            <span className="block text-amber text-[0.68rem] font-mono tracking-[0.08em] mb-2 not-italic">
              SCENARIO
            </span>
            {q.context}
          </div>
        ...
        {showExplanation && (
          ...
          >
            ...
            {/* Real World Note */}
            {q.realWorldNote && (
              <div className="mt-4 bg-amber/[6%] border border-amber/20 rounded-[10px] px-5 py-4">
                <p className="text-amber text-[0.68rem] font-mono tracking-[0.08em] mb-[0.4rem]">
                  IN PRACTICE
                </p>
